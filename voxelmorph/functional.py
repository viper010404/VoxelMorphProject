...
def random_disp(
    ...
    dimension and stacking them along the last dimension.
    ...
    # Stack along last dimension to create displacement field
    disp = torch.stack(disp_components, dim=-1)

    if integrations > 0:
        if not has_batch:
            # Pure spatial: integrate directly
